...
const DISABLE_SOUND_ENV: &str = "SHEPHERD_DISABLE_SOUND";
#[cfg(not(any(windows, target_os = "macos")))]
...
fn temp_sound_path() -> PathBuf {
    ...
    std::env::temp_dir().join(format!("shepherd-sound-{}-{id}.mp3", std::process::id()))
}
