...
pub(super) fn ghostty_prefers_shepherd_text_encoding(key: crate::input::TerminalKey) -> bool {
...
pub(super) fn ghostty_mouse_encoder_for_terminal(
    ...
    if terminal
        ...
        .ok()?
    {
        // Shepherd receives host mouse positions in terminal cells. Downgrade
