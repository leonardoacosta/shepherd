...
pub struct AppState {
    ...
    /// Last reported focus state for the outer terminal hosting shepherd.
    ...
    /// Capture mouse input for Shepherd's own mouse UI. When false, Shepherd only
    ...
    pub right_panel_rows: Vec<Vec<crate::config::AgentSidebarToken>>,
    ...
    /// Installed or linked plugins known to this running Shepherd instance.
...
impl AppState {
    ...
    pub fn test_new() -> Self {
        Self {
            ...
            worktree_directory: std::path::PathBuf::from("/tmp/shepherd-worktrees"),
            ...
            update_install_command: "shepherd update".into(),
            ...
            right_panel_width: crate::config::RightPanelConfig::default().width,
            right_panel_rows: crate::config::RightPanelConfig::default().rows,
            dock_enabled: false,
    ...
    fn view_state_field_set_matches_stage1_freeze() {
        assert_eq!(
            ...
            &[
                ...
                // token-driven presentation region, so its geometry belongs in the
                // client view beside `topbar_rect`, not in server/runtime state.
                "right_panel_rect",
                "dock_rect",
                "dock_pane_info",
                "tab_hit_areas",
