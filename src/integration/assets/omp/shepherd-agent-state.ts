...
const idleDebounceMs = parseDurationEnv("SHEPHERD_OMP_IDLE_DEBOUNCE_MS", 250);
const retryGraceMs = parseDurationEnv("SHEPHERD_OMP_RETRY_GRACE_MS", 2500);
