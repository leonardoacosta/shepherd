...
template: splash
hero:
  tagline: "Install, learn, and configure Shepherd. Start on the path that matches you — no multiplexer experience required."
  image:
    file: ../../../public/assets/logo.svg
  actions:
    - text: Install Shepherd
      link: /docs/install/
    - text: Quick start
...
<CardGrid>
  <Card title="New to terminal multiplexers?">
    You don't need to learn shortcuts to start. Shepherd is mouse-first: click panes, drag borders, split and switch from right-click menus.
...
```text
Help me understand and set up Shepherd. Read https://shepherd.dev/agent-guide.md first, then walk me through it step by step.
```

The guide teaches your agent Shepherd's concepts, setup, configuration, and common fixes, so its answers stay accurate instead of improvised.
...
<CardGrid>
  ...
  <Card title="Configuration">
    ...
    [Configure Shepherd →](/docs/configuration/)
  </Card>
  <Card title="API">
    Control Shepherd from scripts, tools, and agents through the CLI and local socket API.
