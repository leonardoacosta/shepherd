...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=SHEPHERD_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=SHEPHERD_BUILD_ID");
    println!("cargo:rerun-if-env-changed=SHEPHERD_BUILD_COMMIT");
